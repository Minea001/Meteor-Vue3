                    ...
                    <tbody>
                        <template v-for="(doc,index) in reportData" :key="index">
                            ...
                            <tr v-for="(it, key) in doc.details" :key="key">
                                ...
                                <td class="text-right">{{ it.cost }}</td>
                                <td class="text-right">{{ it.amount }}</td>
                            </tr>
                            <tr>
                                <th class="text-right" colspan="4">Total</th>
                                <th class="text-right">{{ doc.totalQty }}</th>
                                <th></th>
                                <td class="text-right">{{ doc.totalAmount }}</td>
                            </tr>
                        </template>
                    </tbody>
                </table>
...
const submit = () => {
    ...
    reportData.value = []
    Meteor.call('purchaseTransactionDetailEmp', { ...selector }, (err, res) => {
        if (err) {
